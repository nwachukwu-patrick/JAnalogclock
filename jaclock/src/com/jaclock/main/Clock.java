...
public class Clock extends JPanel implements Runnable
{
    ...
    private void drawStructure(Graphics g) {
        ...
        g.drawString("Programmed By Patrick", 50, 350);
        g.setColor(Color.green);
        g.drawString("9", xcenter - 145, ycenter + 0);
        g.drawString("10", xcenter - 125, ycenter - 50);
        g.drawString("11", xcenter - 85, ycenter - 100);

        g.drawString("1", xcenter + 65, ycenter - 115);
        g.drawString("2", xcenter + 115, ycenter - 60);
        g.drawString("3", xcenter + 135, ycenter + 0);
        g.drawString("12", xcenter - 10, ycenter - 130);
        g.drawString("4", xcenter + 120, ycenter + 70);
        g.drawString("5", xcenter + 65, ycenter + 130);
        g.drawString("6", xcenter - 10, ycenter + 145);
        g.drawString("7", xcenter - 80, ycenter + 120);
        g.drawString("8", xcenter - 130, ycenter + 75);
